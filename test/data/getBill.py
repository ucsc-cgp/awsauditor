...
KEY = "small_cost_allocation.csv"
DESTINATION = KEY + '-download'
BILL_HISTORY = 'new_history'  # 'bill-history-%d-%d.csv' % (now.year, now.month)
...
def getNewBill():
    ...
    client.upload_file(KEY, BUCKET_NAME, KEY)
